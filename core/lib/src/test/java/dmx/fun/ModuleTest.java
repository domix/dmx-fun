...
/**
 * Validates the JPMS module descriptor for {@code dmx.fun}.
 *
...
class ModuleTest {
    ...
    private static final String MODULE_NAME = "dmx.fun";
    ...
    void module_exportsPublicPackage() {
        ...
        assertTrue(exported.contains("dmx.fun"),
            "Expected 'dmx.fun' to be exported, but exports were: " + exported);
    }
    ...
    void module_doesNotExportInternalPackages() {
        ...
        assertEquals(Set.of("dmx.fun"), exported,
