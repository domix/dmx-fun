...
description: "How to use fun-jakarta-jaxb: JsonbAdapter implementations for all dmx-fun types (JSON-B), and XmlAdapter implementations for Option, Result, Try, and Either (JAXB)."
order: 20
