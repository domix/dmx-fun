...
the rationale is documented in <a href={`${base}adr/adr-022-integration-modules`}>ADR-022 — Integration modules as optional peer dependencies</a>.

<div style="text-align: center; margin: 1.5rem 0;">
  <img
    src={`${base}dmx-fun-modules.png`}
    alt="dmx-fun module ecosystem — core library at the center surrounded by integration modules for Spring, Quarkus, Jackson, Jakarta, Micrometer, Resilience4j, HTTP, and more"
...
| `codes.domix:fun-spring-webflux` | Spring WebFlux adapters — Option/Result/Try/Validated to ServerResponse for functional endpoints |
...
| `codes.domix:fun-reactor` | Project Reactor interop — convert Option, Result, and Try to/from Mono/Flux, with railway operators and sequence/collectValidated aggregation |
