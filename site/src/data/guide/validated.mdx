...
| `Validated` → `Optional`  | `v.toOptional()`                               |
| `Validated` → `Stream`    | `v.stream()`                                   |
...
| `Either` → `Validated`    | `Validated.fromEither(either)`                 |
| `Optional` → `Validated`  | `Validated.fromOptional(optional, errorIfEmpty)` |
