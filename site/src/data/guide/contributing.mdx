...
> **Note**: `pnpm run build` in `site/` copies the Javadoc from `build/reports/javadoc/` into the
...
| `jackson-compatibility.yaml`     | `-PjacksonVersion`   | `2.14.3` – `2.22.1`    |
| `spring-compatibility.yaml`      | `-PspringVersion`    | `6.0.23` – `7.0.8`     |
