...
The design rationale — including the exception-merging contract, the internal representation,
and alternatives considered — is documented in <a href={`${base}adr/adr-021-resource-composable`}>ADR-021 — Resource&lt;T&gt; as composable managed resource</a>.
